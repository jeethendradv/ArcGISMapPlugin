...
public class PluginEnvironment extends CordovaPlugin {
  ...
  public void isAvailable(final JSONArray args, final CallbackContext callbackContext) throws JSONException {
    ...
    // ------------------------------
    /*int checkGooglePlayServices = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(cordova.getActivity());
  ...
  public void setBackGroundColor(final JSONArray args, final CallbackContext callbackContext) throws JSONException {
    ...
    final CordovaArcGISMap googleMaps = (CordovaArcGISMap) pluginManager.getPlugin("CordovaArcGISMap");
